...
def apply_filter(name, datasets=None, features=None, options=None, as_dataframe=None, expand=None,
    ...
    Args:
        ...
        display_name (string, Optional, Default=None):
            overide default display name generated by filter
        description (string, Optional, Default=None):
            overide default description generated by filter
        metadata (dict, Optional, Default=None):
            overide default metadata generated by filter
    ...
    result = driver.apply_filter(datasets, features, options, display_name=display_name, description=description, metadata=metadata)
