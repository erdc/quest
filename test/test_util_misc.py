...
def test_get_dsl_dir(reset_projects_dir):
    assert dsl.util.get_dsl_dir() == reset_projects_dir['BASE_DIR']


def test_get_cache_data_dir(reset_projects_dir):
    assert dsl.util.get_cache_dir() == os.path.join(reset_projects_dir['BASE_DIR'], 'cache')
    assert dsl.util.get_projects_dir() == os.path.join(reset_projects_dir['BASE_DIR'], 'projects')
